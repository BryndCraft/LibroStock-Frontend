      ...
      <table className="w-full">
        <thead>
          <tr className="bg-gradient-to-r from-slate-50/80 to-blue-50/50 border-b border-slate-200/40">
            <th className="text-left p-6 font-semibold text-slate-700 text-sm uppercase tracking-wider">
              Producto
            </th>
            <th className="text-left p-6 font-semibold text-slate-700 text-sm uppercase tracking-wider">
              Categoría
        ...
        <tbody>
          {productosFiltrados.map((producto) => (
            ...
            >
              ...
              <td className="p-6">
                <span
                  className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium border backdrop-blur-sm ${getColorStock(
                    producto
                  )}`}
                >
              ...
              <td className="p-6">
                {vista_facturacion ? (
                  <button
                    ...
                    className="p-3 bg-blue-600 text-white hover:bg-blue-800 rounded-xl transition-all duration-200 hover:scale-105 border border-blue-200/60 backdrop-blur-sm hover:border-blue-200/80 cursor-pointer"
