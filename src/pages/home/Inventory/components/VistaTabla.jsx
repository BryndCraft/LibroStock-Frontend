...
export function VistaTabla({
  ...
  const headerClass = (baseClass) =>
    `${baseClass} ${vista_facturacion ? "p-3 text-xs" : "p-6 text-sm"}`;

  const cellClass = (baseClass) =>
    `${baseClass} ${vista_facturacion ? "p-3" : "p-6"}`;
          ...
          <tr className="bg-gradient-to-r from-slate-50/80 to-blue-50/50 border-b border-slate-200/40">
            <th
              className={headerClass(
                "text-left font-semibold text-slate-700 uppercase tracking-wider"
              )}
            >
              Producto
            </th>
            ...
            >
              <td className={cellClass("")}>
                ...
                >
                  ...
                  <div>
                    <div className={productNameClass}>{producto.nombre}</div>
              ...
              <td className={cellClass("")}>
                <span
                  className={`inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-50/80 text-purple-700 border border-purple-200/60 backdrop-blur-sm ${
              ...
              <td className={cellClass("")}>
                <div className="flex items-center gap-2">
                  <LocalOffer
                    className={`${
                      vista_facturacion ? "w-4 h-4" : "w-5 h-5"
                    } text-emerald-500`}
                  />
                  <span
              ...
              <td className={cellClass("")}>
                {vista_facturacion ? (
                  ...
                  >
                    <Edit
                      className={`${vista_facturacion ? "w-4 h-4" : "w-5 h-5"}`}
                    />
                    <span>
                      {vista_facturacion ? "Agregar" : "Agregar al Carrito"}
                    </span>
                  </button>
                ) : (
